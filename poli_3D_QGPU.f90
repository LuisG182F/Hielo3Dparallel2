...
integer :: permutaciones(0:NUM_PERMUTACIONES-1, 0:7)
...
call inicializar_gpu(c, filas, columnas, ancho, permutaciones_host)

!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

do posicion_local_idx = 0, 7 ! Índice del paso (0-7)
      do color = 0, 7
            call ejecutar_montecarlo_en_gpu(c, filas, columnas, ancho, color, posicion_local_idx, time)
      end do
end do

!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

call finalizar_gpu(c) ! Limpiar memoria de la GPU
